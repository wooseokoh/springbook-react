...
public class BookService {
	...
	public Book 수정하기(Long id, Book book) {
		...
		Book bookEntity = bookRepository.findById(id)
				.orElseThrow(() -> new IllegalArgumentException("id를 확인해주세요!!!")); // 영속화 (Book 오브젝트 - spring 내부 메모리에 들고있음 따로..) -> 영속성 컨텍스트 보관
	...
	public String 삭제하기(Long id) {
		bookRepository.deleteById(id); // 오류가 터지면 익셉션을 타니까... 신경쓰지 말기
		return "ok";
	}
}
